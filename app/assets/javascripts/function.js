function myFunction() {
      ...
      document.getElementById("challenge").innerHTML = total1.toFixed(2);
      document.getElementById("environment").innerHTML = total2.toFixed(2);
      document.getElementById("economics").innerHTML = total3.toFixed(2);
      document.getElementById("competencies").innerHTML = total4.toFixed(2);
